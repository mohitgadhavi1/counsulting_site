...
function Hero({ scrollToSection }: HeroProps) {
  ...
  return (
    <section
      id="home"
      className="min-h-screen flex flex-col overflow-hidden text-wrap w-full relative"
      style={{
    ...
    >
      ...
      <div className="relative z-50 pt-8">
        <div className="flex justify-between items-center px-8">
          ...
          <motion.button
            ...
            className="cursor-pointer bg-white/20 hover:bg-white/30 backdrop-blur-sm text-white font-medium px-6 py-3 rounded-full shadow-lg transition-colors border border-white/30"
      ...
      <div className="absolute bottom-0 left-0 right-0 h-16 bg-gradient-to-t from-background via-background/80 to-transparent pointer-events-none z-10"></div>
      ...
      {/* Hero Content */}
      <div className="flex-1 flex items-center justify-center relative z-20 mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div>
          ...
          <motion.p
            className="text-xl md:text-2xl mb-8 text-white/90 max-w-3xl mx-auto drop-shadow-lg"
          ...
          >
            <Button
              ...
              className="bg-primary hover:bg-primary/90 text-white px-8 py-6 text-lg rounded-lg transition-all duration-300 hover:scale-105 cursor-pointer shadow-xl backdrop-blur-sm"
            >
            ...
            <Button
              ...
              variant="outline"
              className="border-2 border-white/80 text-white hover:bg-white/20 hover:text-white px-8 py-6 text-lg rounded-lg transition-all duration-300 cursor-pointer backdrop-blur-sm shadow-xl"
            >
              Our Services
            </Button>
          </motion.div>
